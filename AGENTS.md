...
This repository is a reusable harness scaffold. Keep this file short. Treat it
as a routing layer plus a small set of non-negotiable operating rules. Put
detailed, durable knowledge under `docs/`.
